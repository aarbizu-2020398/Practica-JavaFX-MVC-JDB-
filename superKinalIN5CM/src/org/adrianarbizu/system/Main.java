...
public Initializable switchScene(String fxmlName, int width, int heigth)throws Exception{
    ...
    public void menuDetalleFacturasView() {
        try{
            MenuDetalleFacturasController menuDetalleFacturasView = (MenuDetalleFacturasController)switchScene("MenuDetalleFacturasView.fxml", 1200, 750);
    ...
    public void formDetalleFacturasView(int i) {
